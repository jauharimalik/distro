...
switch ($_GET['act']) {
	...
	if (isset($_POST['add'])) {
		...
		if($_POST['produkid']>0){
			...
			//addtocart($pid,$q,$s);
			if(produk_exist($pid)){
				$pesan = "<div class=\"msg msg-warn\"><i class=\"fa fa-warning\" style='vertical-align:middle'></i> \"$d[produk_nama]\" Sudah ada di <a href=\"cart\">Keranjang Belanja</a> kamu.</div>";
			} else { 
				if ($_POST['qty']<=$d['stok']) {
					...
					$pesan = "<div class=\"msg msg-sukses\"><i class=\"fa fa-check-square-o\" style='vertical-align:middle'></i> \"$d[produk_nama]\" Berhasil ditambahkan ke <a href=\"cart\">Keranjang Belanja</a> kamu.</div>";
			...
			//exit();
			//$_SESSION['subtotal']+=($_POST['harga']*$_POST['qty']);		
			//$pesan = "<div class=\"msg msg-warn\"><i class=\"fa fa-warning\" style='vertical-align:middle'></i> \"$d[produk_nama]\" Sudah ada di <a href=\"cart\">Keranjang Belanja</a></div>";		
			//$pesan = "<div class=\"msg msg-sukses\"><i class=\"fa fa-check-square-o\" style='vertical-align:middle'></i> \"$d[produk_nama]\" Berhasil ditambahkan ke <a href=\"cart\">Keranjang Belanja</a></div>";
		}
	}
	?>
		<div class="detail">
				...
				<div class="detail-desc">
					<form action="" method="post" class="form">
						<table border="1px" cellspacing="10" cellpadding="10" style="width:100%">
							...
							<tr>
								<td colspan="2"><button name="add" class="buton primary" onclick="document.location.reload(true);"><i class="fa fa-shopping-cart"></i> Klik Beli</button></td>
							</tr>
							<tr>
