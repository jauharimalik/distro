...
switch ($_GET['act']) {
	...
	case 'akunsaya':
		if (empty($_SESSION['ecust'])) {
			...
			$custs = $_SESSION['cust'];
			$cek_query = mysql_query("select * from cust_users where  cust_fn = '$custs'");
			$cek_user = mysql_num_rows($cek_query);
			$data_user = mysql_fetch_array($cek_query);
			...
			<div class="shop-cart">
				<div class="container clear">
					...
					<p>Hello <b><?php echo $_SESSION['cust']."</b> (".$_SESSION['ecust'].") selamat datang di HAS Collection, show your inner beauty - shine and syar'i";?></p>
					<br><br>
						...
						<div style="float:left">
							...
							<table class="inv">
								...
								<tr>
									<td width="">Nama</td>
									<td>: </td>
									<td><?php echo $d['nama']?><input type="hidden" name="orderid" value="<?php echo $d['order_id']?>"></td>
								</tr>
								<tr>
									<td>Kota</td>
									<td>: </td>
